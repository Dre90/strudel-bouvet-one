...
const kick = s("bd*4")
  ...
  .lpf(2500)
  .gain(0.95)
  .duckorbit(2).duckattack(0.3).duckdepth(0.45)
...
const sub = prog
  ...
  .struct("~ x ~ x")
  .s("sine")
  .decay(0.3).sustain(0.5).release(0.05)
  .lpf(150)
  .gain(0.4)
...
const full = stack(wind, kick, clap, hats, openHat, shaker, conga, bass, sub, stabs, pad, glitter)
